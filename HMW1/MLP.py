...
def main():
	...
	mlp = MLP(train_x.shape[1], np.unique(train_y).shape[0])
	train_accuracy, dev_accuracy = mlp.train(train_x, train_y, devX=dev_x, devY=dev_y)
	mlp.plot_train(train_accuracy, dev_accuracy)
